...
| Name | Version |
|------|---------|
| <a name="provider_azapi"></a> [azapi](#provider\_azapi) | >=1.1 |
...
| <a name="input_AdvancedNetworkingConfig"></a> [AdvancedNetworkingConfig](#input\_AdvancedNetworkingConfig) | An object to define the configuration of advanced networking service | <pre>object({<br/>    Enabled = optional(bool, true)<br/>    ObservabilityEnabled = optional(bool, false)<br/>    AccelerationMode = optional(string, "None")<br/>    SecurityEnabled = optional(bool, true)<br/>    AdvancedNetworkPolicies = optional(string, "L7")<br/>    TransitEncryption = optional(string, "WireGuard")<br/>  })</pre> | <pre>{<br/>  "Enabled": true,<br/>  "TransitEncryption": "WireGuard"<br/>}</pre> | no |
...
| <a name="input_DisableKubeProxy"></a> [DisableKubeProxy](#input\_DisableKubeProxy) | A bool to Enable/Disable kubeproxy through the azapi provider | `bool` | `null` | no |
